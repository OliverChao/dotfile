...
vim.api.nvim_set_keymap('o', 'F', "<cmd>lua require'hhint_wordsop'.hint_char1({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR, current_line_only = true, inclusive_jump = true })<cr>", {})
